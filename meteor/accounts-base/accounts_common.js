...
if (global.isServer) {
    var OAuthEncryption = require('meteor/oauth-encryption')
}
...
exports.EXPIRE_TOKENS_INTERVAL_MS = 600 * 1000; // 10 minutes
// how long we wait before logging out clients when Meteor.logoutOtherClients is
// called
exports.CONNECTION_CLOSE_DELAY_MS = 10 * 1000;
...
Accounts.config = function(options) {
  ...
  if (_.has(options, "oauthSecretKey")) {
    ...
    OAuthEncryption.loadKey(options.oauthSecretKey);
  ...
  if (Meteor.isServer)
    require("./accounts_server").maybeStopExpireTokensInterval();
};
...
if (Meteor.isClient) {
  ...
  if (Meteor.getConfig("accounts_connection_url")) {
    ...
    Accounts.connection = Meteor.DDP.connect(
      Meteor.getConfig("accounts_connection_url"))
  }
}
...
var getTokenLifetimeMs = exports.getTokenLifetimeMs = function () {

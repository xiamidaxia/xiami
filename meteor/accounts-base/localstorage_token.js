...
var autoLoginEnabled = require('./url_client').autoLoginEnabled
...
exports.storeLoginToken = function(userId, token, tokenExpires) {
...
exports.unstoreLoginToken = function() {
...
//
exports.storedLoginToken = Accounts._storedLoginToken = function() {
  return Meteor._localStorage.getItem(loginTokenKey);
};

exports.storedLoginTokenExpires = function () {
...
if (autoLoginEnabled) {
  ...
  var token = exports.storedLoginToken();
  if (token) {
    ...
    Meteor.loginWithToken(token, function (err) {
      if (err) {
        ...
        require('./accounts_client').makeClientLoggedOut();
      }
    });
  }
}
...
var pollStoredLoginToken = function() {
  ...
  var currentLoginToken = exports.storedLoginToken();

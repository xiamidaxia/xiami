...
var test = require('meteor/test-helpers').fixTest.asMeteorTest(test)
...
it("binary-heap - big test for max-heap", function (done) {
...
it("binary-heap - min-max heap tests", function (done) {
...
it("binary-heap - big test for min-max-heap", function (done) {
  var N = 500;

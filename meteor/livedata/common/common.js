...
var DDP = exports.DDP = Meteor.DDP = {}

var SUPPORTED_DDP_VERSIONS = DDP.SUPPORTED_DDP_VERSIONS = [ 'pre2', 'pre1' ];

LivedataTest.SUPPORTED_DDP_VERSIONS = SUPPORTED_DDP_VERSIONS;

var MethodInvocation = exports.MethodInvocation = function (options) {
  var self = this;
...
DDP.parseDDP = function (stringMessage) {
  try {

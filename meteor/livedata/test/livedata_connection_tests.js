...
it("livedata stub - receive data", function (done) {
...
it("livedata stub - subscribe", function (done) {
  var stream = new StubStream();
  var conn = newConnection(stream);
...
it("livedata stub - reactive subscribe", function (done) {
  var stream = new StubStream();
  var conn = newConnection(stream);
...
it("livedata stub - this", function (done) {
  var stream = new StubStream();
  var conn = newConnection(stream);
...
if (Meteor.isClient) {
  it("livedata stub - methods", function (done) {
    var stream = new StubStream();
    var conn = newConnection(stream);
...
it("livedata stub - mutating method args", function (done) {
  var stream = new StubStream();
  var conn = newConnection(stream);
...
if (Meteor.isClient) {
  it("livedata stub - methods calling methods", function (done) {
    var stream = new StubStream();
    var conn = newConnection(stream);
...
it("livedata stub - method call before connect", function (done) {
  var stream = new StubStream;
  var conn = newConnection(stream);
...
it("livedata stub - reconnect", function (done) {
  var stream = new StubStream();
  var conn = newConnection(stream);
...
if (Meteor.isClient) {
  it("livedata stub - reconnect method which only got result", function (done) {
    var stream = new StubStream;
    var conn = newConnection(stream);
    startAndConnect(test, stream);
...
it("livedata stub - reconnect method which only got data", function (done) {
  var stream = new StubStream;
  var conn = newConnection(stream);
  startAndConnect(test, stream);
...
if (Meteor.isClient) {
  it("livedata stub - multiple stubs same doc", function (done) {
    var stream = new StubStream;
    var conn = newConnection(stream);
    startAndConnect(test, stream);
...
if (Meteor.isClient) {
  it("livedata stub - unsent methods don't block quiescence", function (done) {
...
it("livedata stub - reactive resub", function (done) {
  var stream = new StubStream();
  var conn = newConnection(stream);
...
it("livedata connection - reactive userId", function (done) {
  var stream = new StubStream();
  var conn = newConnection(stream);
...
it("livedata connection - two wait methods", function (done) {
  var stream = new StubStream();
  var conn = newConnection(stream);
  startAndConnect(test, stream);
...
it("livedata connection - onReconnect prepends messages correctly with a wait method", function(done) {
  var stream = new StubStream();
  var conn = newConnection(stream);
  startAndConnect(test, stream);
...
it("livedata connection - ping without id", function (done) {
  var stream = new StubStream();
  var conn = newConnection(stream);
  startAndConnect(test, stream);
...
it("livedata connection - ping with id", function (done) {
  var stream = new StubStream();
  var conn = newConnection(stream);
  startAndConnect(test, stream);
...
itAsync("livedata connection - version negotiation requires renegotiating",
...
itAsync("livedata connection - version negotiation error",
                  function (test, onComplete) {
  var connection = new LivedataTest.Connection(getSelfConnectionUrl(), {
    reloadWithOutstanding: true,
...
it("livedata connection - onReconnect prepends messages correctly without a wait method", function(done) {
  var stream = new StubStream();
  var conn = newConnection(stream);
  startAndConnect(test, stream);
...
it("livedata connection - onReconnect with sent messages", function(done) {
  var stream = new StubStream();
  var conn = newConnection(stream);
  startAndConnect(test, stream);
...
it("livedata stub - reconnect double wait method", function (done) {
  var stream = new StubStream;
  var conn = newConnection(stream);
  startAndConnect(test, stream);
...
it("livedata stub - subscribe errors", function (done) {
  var stream = new StubStream();
  var conn = newConnection(stream);
...
if (Meteor.isClient) {
  it("livedata stub - stubs before connected", function (done) {
    var stream = new StubStream();
    var conn = newConnection(stream);

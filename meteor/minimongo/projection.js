...
var MinimongoError = require('./minimongo').MinimongoError
...
var projectionDetails = exports.projectionDetails = function (fields) {
...
var pathsToTree = exports.pathsToTree = function (paths, newLeafFn, conflictFn, tree) {
  tree = tree || {};

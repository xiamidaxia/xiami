...
var MinimongoTest = require('./minimongo').MinimongoTest
...
var GeoJSON = require('meteor/geojson-utils')
...
var regexpElementMatcher = exports.regexpElementMatcher = function (regexp) {
...
var equalityElementMatcher = exports.equalityElementMatcher = function (elementSelector) {
...
// return.
var makeLookupFunction = exports.makeLookupFunction = function (key) {
  var parts = key.split('.');
...
var expandArraysInBranches = exports.expandArraysInBranches = function (branches, skipTheArrays) {
  var branchesOut = [];

...
var MongoConnection = exports.MongoConnection = function (url, options) {
  var self = this;
  options = options || {};
...
var CursorDescription = exports.CursorDescription = function (collectionName, selector, options) {
  var self = this;
...
var Cursor = exports.Cursor = function (mongo, cursorDescription) {
  var self = this;
...
var listenAll = exports.listenAll = function (cursorDescription, listenCallback) {
  var listeners = [];
...
var forEachTrigger = exports.forEachTrigger = function (cursorDescription, triggerCallback) {

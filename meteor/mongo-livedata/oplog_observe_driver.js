...
var MinMaxHeap = require('meteor/binary-heap').MinMaxHeap
var MaxHeap = require('meteor/binary-heap').MaxHeap
var LocalCollection = require('meteor/minimongo').LocalCollection
var forEachTrigger = require('./mongo_driver').forEachTrigger
var listenAll = require('./mongo_driver').listenAll
var CursorDescription = require('./mongo_driver').CursorDescription
var MongoInternals = require('./mongo_driver').MongoInternals
var idForOp = require('./oplog_tailing').idForOp
...
var OplogObserveDriver = module.exports = function (options) {
  var self = this;

...
var OPLOG_COLLECTION = exports.OPLOG_COLLECTION = 'oplog.rs';
...
var idForOp = exports.idForOp = function (op) {
  if (op.op === 'd')
    return op.o._id;
  else if (op.op === 'i')
    return op.o._id;
...
var OplogHandle = exports.OplogHandle = function (oplogUrl, dbName) {
  var self = this;
...
_.extend(OplogHandle.prototype, {
  ...
  _startTailing: function () {
    var MongoConnection = require('./mongo_driver').MongoConnection

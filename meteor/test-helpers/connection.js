...
var simplePoll = require('./poll').simplePoll
...
// failure.
exports.makeTestConnection = function (test, succeeded, failed) {
  ...
  clientConn = Meteor.DDP.connect(Meteor.absoluteUrl(), {retry: false});
  simplePoll(
    function () {
